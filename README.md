...
To see the design layout

Tech Stack
- HTML/CSS

Possible Future Improvements
- The website pages do seem awkward and less put together, consider making the design much cleaner and professional
- Try adding moving pictures and unique design elements that separate each web page from each other rather than using just images
